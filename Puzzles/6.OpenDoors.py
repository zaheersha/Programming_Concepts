# Consider a long alley with a N number of doors on one side. All the doors are closed initially. You move to
# and from in the alley changing the states of the doors as follows: you open a door that is already closed
# and you close a door that is already opened. You start at one end go on altering the state of the doors till
...
def noOfOpenedDoors(N):
    ans = int(math.sqrt(N))
    return ans

print(noOfOpenedDoors(4))
